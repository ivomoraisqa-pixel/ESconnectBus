          ...
          <div class="noc-card-preview-container">
            <div class="noc-preview-map noc-preview-layer" style="opacity: 1;">
              ...
              <div style="flex:1; display:flex; flex-direction:column; justify-content:center; padding:8px; gap:6px;">
                ${totemArrivals.length > 0 ? totemArrivals.slice(0,2).map(a => `
                  <div style="display:flex; justify-content:space-between; font-size:9px; border-bottom:1px solid #eee; padding-bottom:4px;">
                    <span style="background:#2D9B5A; color:white; padding:2px 4px; border-radius:4px; font-weight:bold;">${a.route_id}</span>
                    <span style="font-weight:bold;">${a.eta_minutes} min</span>
                  </div>
                `).join('') : `
                  <div style="display:flex; justify-content:space-between; font-size:9px; border-bottom:1px solid #eee; padding-bottom:4px;">
                    <span style="background:#2D9B5A; color:white; padding:2px 4px; border-radius:4px; font-weight:bold;">501</span>
                    <span style="font-weight:bold;">3 min</span>
                  </div>
                `}
              </div>
          ...
          <div class="noc-card-content">
            <div>
              ...
              <div class="noc-bus-list">
                ${totemArrivals.length > 0 ? totemArrivals.map(a => `
                  <div class="noc-bus-item"><span class="noc-bus-badge" style="background:#2D9B5A;">${a.route_id}</span><span style="font-weight:600;">${a.eta_minutes} min</span></div>
                `).join('') : `
                  <div class="noc-bus-item"><span class="noc-bus-badge" style="background:#2D9B5A;">501</span><span style="font-weight:600;">3 min</span></div>
                  <div class="noc-bus-item"><span class="noc-bus-badge" style="background:#3B82F6;">523</span><span style="font-weight:600;">7 min</span></div>
                `}
              </div>
            </div>
